...
2. Le traitement du bord pour minimiser les erreurs qui se produisent. 
  - Les valeurs de bord ne sont ni initialisees lors de la creation ni ecrasees lors d'un operation de morpho.
  - Les valeurs aleatoires sont le facteur principal d'un mauvais resultat lors d'un traitement enchaine des morpho (Erosion - Dilatation - Dilatation - Erosion). 
...
3. Restructurer les entetes des fonction de morpho pour 
  ...
  - ajouter un parametre pour un buffer intermediaire. 
    - la fonction avec la meilleure optimisation perd le temps avec creation d'un buffer intermediaire.
    - le traitement enchaine (E-D-D-E) en a besoin. 
