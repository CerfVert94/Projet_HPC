...
void test_implementation_erosion3  (struct morpho_set *morpho_set, bool logging);
void test_implementation_dilation3 (struct morpho_set *morpho_set, bool logging);
void test_implementation_erosion5  (struct morpho_set *morpho_set, bool logging);
void test_implementation_dilation5 (struct morpho_set *morpho_set, bool logging);
