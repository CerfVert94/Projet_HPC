...
unsigned long long get_cpu_cycles_of_sd               (struct sd_set       *sdsets                  , uint8** X, uint8** Y, uint8** Z, long nrl, long nrh, long ncl, long nch, uint8 n_coeff, uint8 v_min, uint8 v_max);
unsigned long long get_min_cpu_cycles_of_sd              (struct sd_set       *sdsets, long packet_size, uint8** X, uint8** Y, uint8** Z, long nrl, long nrh, long ncl, long nch, uint8 n_coeff, uint8 v_min, uint8 v_max);
